...
(function () {
  ...
  // 24 spans, lengths 30..53 frames, evenly spaced, applied latest-first.
  var spans = [];
  for (var i = 0; i < 24; i++) {
    var startF = Math.round((100 + i * 80) / FRAME);
    var lenF = 30 + i;
    spans.push({ startF: startF, lenF: lenF });
  }
  ...
  L.push('24 spans, lengths 30..53 frames');
